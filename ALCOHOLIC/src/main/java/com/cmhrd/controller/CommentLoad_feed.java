...
public class CommentLoad_feed extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<user_coc_commentDTO> list = dao.loadcomment_feed(dto);
        ...
        for (int i = 0; i < list.size(); i++) {
        	user_coc_commentDTO post = list.get(i);
        	json.append("{");
            json.append("\"index\":\"").append(escapeJson(Integer.toString(post.getUser_ct_idx()))).append("\",");
