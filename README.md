...
### 중요성
기존의 칵테일 관련 플랫폼들은 주로 정보 제공에 집중되어 있어, 사용자 간의 상호작용이 제한적입니다. 이 프로젝트는 사용자들이 서로의 레시피와 경험을 공유하며, 더 나은 칵테일 문화를 형성하는 데 중점을 둡니다. 이를 통해 칵테일 입문자들도 쉽게 접근할 수 있으며, 전문가들의 독창적인 레시피를 접할 수 있는 기회를 제공합니다.
